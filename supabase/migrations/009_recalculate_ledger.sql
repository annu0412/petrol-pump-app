...
BEGIN
    ...
    LOOP
        ...
        SELECT
            ...
            COALESCE(SUM(phonepe + sbi + icici + paytm + dt_plus + neft), 0)
        ...
        v_cash_generated := v_total_sale - v_total_digital - v_total_expense - v_total_credit + COALESCE(v_summary.cash_received, 0);
