...
export default function DailyDetails({ date, orgId, summary }: Props) {
  const role = useRole()
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="font-bold text-[#003087]">Master Entry</h3>
            {isOwner && (
            <Link href={`/master?date=${date}`} className="text-sm flex items-center gap-1 text-blue-600 hover:underline">
              Edit Master <ExternalLink size={14} />
            </Link>
            )}
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              {isOwner && (
              <Link href={`/expense?date=${date}`} className="text-sm flex items-center gap-1 text-blue-600 hover:underline">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              {isOwner && (
              <Link href={`/credit?date=${date}`} className="text-sm flex items-center gap-1 text-blue-600 hover:underline">
                Edit <ExternalLink size={14} />
              </Link>
              )}
            </div>
